...
const main = async (): Promise<any> => {
  ...
  let evmInput: EVMInput = new EVMInput(cHexAddress, axcBalance, axcAssetIDStr, nonce)
  ...
  let secpTransferOutput: SECPTransferOutput = new SECPTransferOutput(axcBalance.sub(fee), xAddresses, locktime, threshold)
  let transferableOutput: TransferableOutput = new TransferableOutput(axcAssetIDBuf, secpTransferOutput)
