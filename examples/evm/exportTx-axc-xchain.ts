...
const main = async (): Promise<any> => {
  ...
  const evmInput: EVMInput = new EVMInput(cHexAddress, balance, axcAssetIDStr, nonce)
  ...
  const transferableOutput: TransferableOutput = new TransferableOutput(axcAssetIDBuf, secpTransferOutput)
