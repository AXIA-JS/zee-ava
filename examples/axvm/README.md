...
Example scripts for the [Axia Virtual Machine](https://docs.axc.network/build/references/axvm-transaction-serialization)
...
* [buildExportTx-appchain-ant.ts](./buildExportTx-appchain-ant.ts)
* [buildExportTx-appchain-axc.ts](./buildExportTx-appchain-axc.ts)
* [buildExportTx-corechain.ts](./buildExportTx-corechain.ts)
* [buildImportTx-appchain.ts](./buildImportTx-appchain.ts)
...
* [exportTx-ant-appchain.ts](./exportTx-ant-appchain.ts)
* [exportTx-axc-appchain.ts](./exportTx-axc-appchain.ts)
...
* [importTx-appchain.ts](./importTx-appchain.ts)
* [importTx-appchain.ts](./importTx-appchain.ts)
