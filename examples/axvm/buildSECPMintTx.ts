...
// ts-node examples/axvm/buildCreateAssetTx.ts
// if you run the axvm.getAllBalances method you will see the asset alongside AXC, and a balance of 507
...
const memo: Buffer = Buffer.from(
  "AXVM utility method buildSECPMintTx to mint an ANT"
)
