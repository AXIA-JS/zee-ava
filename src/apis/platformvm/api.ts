...
export class PlatformVMAPI extends JRPCAPI {
   ...
   */
  exportAXC = async (username: string, password:string, amount:BN, to:string,):Promise<string> => {
    const params:any = {
      username,
      password,
      to,
   ...
   * by calling issueTx.
   */
  importAXC = async (username: string, password:string, to:string, sourceChain:string)
  :Promise<string> => {
    const params:any = {
      to,
      sourceChain,
