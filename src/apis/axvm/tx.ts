...
export const SelectTxClass = (txtype: number, ...args: any[]): BaseTx => {
  if (txtype === AXVMConstants.BASETX) {
    return new BaseTx(...args)
  } else if (txtype === AXVMConstants.CREATEASSETTX) {
    return new CreateAssetTx(...args)
  } else if (txtype === AXVMConstants.OPERATIONTX) {
    return new OperationTx(...args)
  } else if (txtype === AXVMConstants.IMPORTTX) {
    return new ImportTx(...args)
  } else if (txtype === AXVMConstants.EXPORTTX) {
