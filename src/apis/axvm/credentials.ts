...
export const SelectCredentialClass = (
  ...
  if (
    credid === AXVMConstants.SECPCREDENTIAL ||
    credid === AXVMConstants.SECPCREDENTIAL_CODECONE
  ) {
    return new SECPCredential(...args)
  }
  if (
    credid === AXVMConstants.NFTCREDENTIAL ||
    credid === AXVMConstants.NFTCREDENTIAL_CODECONE
  ) {
...
export class SECPCredential extends Credential {
  ...
  protected _typeID =
    this._codecID === 0
      ? AXVMConstants.SECPCREDENTIAL
      : AXVMConstants.SECPCREDENTIAL_CODECONE
...
export class NFTCredential extends Credential {
  ...
  protected _typeID =
    this._codecID === 0
      ? AXVMConstants.NFTCREDENTIAL
      : AXVMConstants.NFTCREDENTIAL_CODECONE
