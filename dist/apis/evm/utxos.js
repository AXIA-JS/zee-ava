...
class UTXOSet extends utxos_1.StandardUTXOSet {
    constructor() {
        ...
        *
        */
        this.buildExportTx = (networkID, blockchainID, amount, axcAssetID, toAddresses, fromAddresses, changeAddresses = undefined, destinationChain = undefined, fee = undefined, feeAssetID = undefined, asOf = helperfunctions_1.UnixNow(), locktime = new bn_js_1.default(0), threshold = 1) => {
            let ins = [];
            let outs = [];
            let exportouts = [];
            ...
            if (typeof feeAssetID === 'undefined') {
                ...
                /* istanbul ignore next */
                throw new Error('Error - UTXOSet.buildExportTx: feeAssetID must match axcAssetID');
            }
