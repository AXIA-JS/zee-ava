...
class EVMAPI extends jrpcapi_1.JRPCAPI {
    ...
    constructor(core, baseurl = '/ext/bc/C/axc', blockchainID = '') {
        ...
        this.export = (username, password, to, amount, assetID) => __awaiter(this, void 0, void 0, function* () {
            ...
            return this.callMethod('axc.export', params).then((response) => response.data.result.txID);
        });
        /**
        ...
        this.exportAXC = (username, password, to, amount) => __awaiter(this, void 0, void 0, function* () {
            ...
            return this.callMethod('axc.exportAXC', params).then((response) => response.data.result.txID);
        });
        /**
        ...
        this.getUTXOs = (addresses, sourceChain = undefined, limit = 0, startIndex = undefined) => __awaiter(this, void 0, void 0, function* () {
            ...
            return this.callMethod('axc.getUTXOs', params).then((response) => {
        ...
        this.importKey = (username, password, privateKey) => __awaiter(this, void 0, void 0, function* () {
            ...
            return this.callMethod('axc.importKey', params).then((response) => response.data.result.address);
        });
        /**
        ...
        this.issueTx = (tx) => __awaiter(this, void 0, void 0, function* () {
            ...
            return this.callMethod('axc.issueTx', params).then((response) => response.data.result.txID);
        });
        /**
        ...
        this.exportKey = (username, password, address) => __awaiter(this, void 0, void 0, function* () {
            ...
            return this.callMethod('axc.exportKey', params).then((response) => response.data.result.privateKey);
        });
        /**
        ...
        this.buildImportTx = (utxoset, toAddress, ownerAddresses, sourceChain, fromAddresses) => __awaiter(this, void 0, void 0, function* () {
            ...
            const builtUnsignedTx = utxoset.buildImportTx(this.core.getNetworkID(), bintools.cb58Decode(this.blockchainID), [toAddress], from, atomics, sourceChain, this.getTxFee(), axcAssetID);
