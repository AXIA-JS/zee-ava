...
export declare class UTXOSet extends StandardUTXOSet<UTXO> {
    ...
    * @returns An unsigned transaction created from the passed in parameters.
    */
    buildAddDelegatorTx: (networkid: number, blockchainid: Buffer, axcAssetID: Buffer, toAddresses: Array<Buffer>, fromAddresses: Array<Buffer>, changeAddresses: Array<Buffer>, nodeID: Buffer, startTime: BN, endTime: BN, stakeAmount: BN, rewardLocktime: BN, rewardThreshold: number, rewardAddresses: Array<Buffer>, fee?: BN, feeAssetID?: Buffer, memo?: Buffer, asOf?: BN) => UnsignedTx;
    /**
      ...
      * @returns An unsigned transaction created from the passed in parameters.
      */
    buildAddValidatorTx: (networkid: number, blockchainid: Buffer, axcAssetID: Buffer, toAddresses: Array<Buffer>, fromAddresses: Array<Buffer>, changeAddresses: Array<Buffer>, nodeID: Buffer, startTime: BN, endTime: BN, stakeAmount: BN, rewardLocktime: BN, rewardThreshold: number, rewardAddresses: Array<Buffer>, delegationFee: number, fee?: BN, feeAssetID?: Buffer, memo?: Buffer, asOf?: BN) => UnsignedTx;
    /**
