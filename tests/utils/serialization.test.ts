  ...
  describe("serialize && deserialize", (): void => {
    ...
    describe("AXVM", (): void => {
      ...
      test("GenesisAsset", (): void => {
        ...
        const notes: string = "AXVM GenesisAsset"
      ...
      test("BaseTx", (): void => {
        ...
        const notes: string = "AXVM BaseTx"
        const serialized: Serialized = serialization.serialize(
          basetx,
          vm,
          hex,
      ...
      test("CreateAssetTx", (): void => {
        ...
        const notes: string = "AXVM CreateAssetTx"
        const serialized: Serialized = serialization.serialize(
          createassettx,
          vm,
          hex,
      ...
      test("OperationTx", (): void => {
        ...
        const notes: string = "AXVM OperationTx"
        const serialized: Serialized = serialization.serialize(
          operationtx,
          vm,
          hex,
      ...
      test("ImportTx", (): void => {
        ...
        const notes: string = "AXVM ImportTx"
        const serialized: Serialized = serialization.serialize(
          importtx,
          vm,
          hex,
      ...
      test("ExportTx", (): void => {
        ...
        const notes: string = "AXVM ExportTx"
        const serialized: Serialized = serialization.serialize(
          exporttx,
          vm,
          hex,
      ...
      test("SECPCredential", (): void => {
        ...
        const notes: string = "AXVM SECPCredential"
        const serialized: Serialized = serialization.serialize(
          secpcredential,
          vm,
          hex,
      ...
      test("NFTCredential", (): void => {
        ...
        const notes: string = "AXVM NFTCredential"
        const serialized: Serialized = serialization.serialize(
          nftcredential,
          vm,
          hex,
      ...
      test("InitialStates", (): void => {
        ...
        const notes: string = "AXVM InitialStates"
        const serialized: Serialized = serialization.serialize(
          initialStates,
          vm,
          hex,
      ...
      test("SECPTransferInput", (): void => {
        ...
        const notes: string = "AXVM SECPTransferInput"
        const serialized: Serialized = serialization.serialize(
          secptransferinput,
          vm,
          hex,
      ...
      test("MinterSet", (): void => {
        ...
        const notes: string = "AXVM MinterSet"
        const serialized: Serialized = serialization.serialize(
          minterset,
          vm,
          hex,
      ...
      test("TransferableOperation", (): void => {
        ...
        const notes: string = "AXVM TransferableOperation"
        const serialized: Serialized = serialization.serialize(
          transferableoperation,
          vm,
          hex,
      ...
      test("SECPMintOperation", (): void => {
        ...
        const notes: string = "AXVM SECPMintOperation"
        const serialized: Serialized = serialization.serialize(
          secpmintoperation,
          vm,
          hex,
      ...
      test("NFTMintOperation", (): void => {
        ...
        // const notes: string = "AXVM NFTMintOperation"
      ...
      test("NFTTransferOperation", (): void => {
        ...
        const notes: string = "AXVM NFTTransferOperation"
        const serialized: Serialized = serialization.serialize(
          nfttransferoperation,
          vm,
          hex,
      ...
      test("UTXOID", (): void => {
        ...
        const notes: string = "AXVM UTXOID"
        const serialized: Serialized = serialization.serialize(
          utxoid,
          vm,
          hex,
      ...
      test("TransferableOutput", (): void => {
        ...
        const notes: string = "AXVM TransferableOutput"
        const serialized: Serialized = serialization.serialize(
          transferableoutput,
          vm,
          hex,
      ...
      test("SECPTransferOutput", (): void => {
        ...
        const notes: string = "AXVM SECPTransferOutput"
        const serialized: Serialized = serialization.serialize(
          secptransferoutput,
          vm,
          hex,
      ...
      test("SECPMintOutput", (): void => {
        ...
        const notes: string = "AXVM SECPMintOutput"
        const serialized: Serialized = serialization.serialize(
          secpmintoutput,
          vm,
          hex,
      ...
      test("NFTMintOutput", (): void => {
        ...
        const notes: string = "AXVM NFTMintOutput"
        const serialized: Serialized = serialization.serialize(
          nftmintoutput,
          vm,
          hex,
      ...
      test("NFTTransferOutput", (): void => {
        ...
        const notes: string = "AXVM NFTTransferOutput"
        const serialized: Serialized = serialization.serialize(
          nfttransferoutput,
          vm,
          hex,
      ...
      test("UnsignedTx", (): void => {
        ...
        const notes: string = "AXVM UnsignedTx"
        const serialized: Serialized = serialization.serialize(
          unsignedtx,
          vm,
          hex,
      ...
      test("UTXOSet", (): void => {
        ...
        const notes: string = "AXVM UTXOSet"
        const serialized: Serialized = serialization.serialize(
          utxoset,
          vm,
          hex,
