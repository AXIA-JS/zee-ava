...
import { KeyChain } from "../../../src/apis/axvm/keychain"
import {
  SECPTransferInput,
  TransferableInput
...
import { BaseTx } from "../../../src/apis/axvm/basetx"
import { CreateAssetTx } from "../../../src/apis/axvm/createassettx"
import { OperationTx } from "../../../src/apis/axvm/operationtx"
import { ImportTx } from "../../../src/apis/axvm/importtx"
import { ExportTx } from "../../../src/apis/axvm/exporttx"
...
describe("Transactions", (): void => {
  ...
  beforeAll(async (): Promise<void> => {
    ...
    api = new AXVMAPI(axia, "/ext/bc/axvm", bID)
  ...
  test("BaseTx codecIDs", (): void => {
    ...
    expect(baseTx.getTypeID()).toBe(AXVMConstants.BASETX)
    baseTx.setCodecID(codecID_one)
    expect(baseTx.getCodecID()).toBe(codecID_one)
    expect(baseTx.getTypeID()).toBe(AXVMConstants.BASETX_CODECONE)
  ...
  test("CreateAssetTx codecIDs", (): void => {
    ...
    expect(createAssetTx.getTypeID()).toBe(AXVMConstants.CREATEASSETTX)
    createAssetTx.setCodecID(codecID_one)
    expect(createAssetTx.getCodecID()).toBe(codecID_one)
    expect(createAssetTx.getTypeID()).toBe(AXVMConstants.CREATEASSETTX_CODECONE)
  ...
  test("OperationTx codecIDs", (): void => {
    ...
    expect(operationTx.getTypeID()).toBe(AXVMConstants.OPERATIONTX)
    operationTx.setCodecID(codecID_one)
    expect(operationTx.getCodecID()).toBe(codecID_one)
    expect(operationTx.getTypeID()).toBe(AXVMConstants.OPERATIONTX_CODECONE)
  ...
  test("ImportTx codecIDs", (): void => {
    ...
    expect(importTx.getTypeID()).toBe(AXVMConstants.IMPORTTX)
    importTx.setCodecID(codecID_one)
    expect(importTx.getCodecID()).toBe(codecID_one)
    expect(importTx.getTypeID()).toBe(AXVMConstants.IMPORTTX_CODECONE)
  ...
  test("ExportTx codecIDs", (): void => {
    ...
    expect(exportTx.getTypeID()).toBe(AXVMConstants.EXPORTTX)
    exportTx.setCodecID(codecID_one)
    expect(exportTx.getCodecID()).toBe(codecID_one)
    expect(exportTx.getTypeID()).toBe(AXVMConstants.EXPORTTX_CODECONE)
  ...
  test("CreateAssetTX", (): void => {
    ...
    expect(txu.getTxType()).toBe(AXVMConstants.CREATEASSETTX)
