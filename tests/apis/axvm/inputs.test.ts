...
describe("Inputs", (): void => {
  ...
  test("SECPInput", (): void => {
    ...
    expect(input.getInputID()).toBe(AXVMConstants.SECPINPUTID)
  ...
  test("SECPTransferInput codecIDs", (): void => {
    ...
    expect(secpTransferInput.getInputID()).toBe(AXVMConstants.SECPINPUTID)
    ...
    expect(secpTransferInput.getInputID()).toBe(
      AXVMConstants.SECPINPUTID_CODECONE
    )
