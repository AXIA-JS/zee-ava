import { UTXO } from "../../../src/apis/axvm/utxos"
import createHash from "create-hash"
import BinTools from "../../../src/utils/bintools"
import BN from "bn.js"
import { Buffer } from "buffer/"
import { NFTTransferOutput } from "../../../src/apis/axvm/outputs"
...
import { UTXOID } from "../../../src/apis/axvm/ops"
...
describe("Operations", (): void => {
  ...
  describe("NFTMintOperation", (): void => {
    ...
    test("Functionality", (): void => {
      ...
      expect(op.getOperationID()).toBe(AXVMConstants.NFTMINTOPID)
    ...
    test("NFTMintOperation codecIDs", (): void => {
      ...
      expect(nftMintOperation.getOperationID()).toBe(AXVMConstants.NFTMINTOPID)
  ...
  describe("NFTTransferOperation", (): void => {
    ...
    test("Functionality", (): void => {
      ...
      expect(op.getOperationID()).toBe(AXVMConstants.NFTXFEROPID)
