...
import { SECPMintOutput } from "../../../src/apis/axvm/outputs"
import { AXVMConstants } from "../../../src/apis/axvm"
...
describe("Outputs", (): void => {
  ...
  describe("NFTMintOutput", (): void => {
    ...
    test("NFTMintOutput codecIDs", (): void => {
      ...
      expect(nftMintOutput.getOutputID()).toBe(AXVMConstants.NFTMINTOUTPUTID)
  ...
  describe("SECPTransferOutput", (): void => {
    ...
    test("SECPMintOutput codecIDs", (): void => {
      ...
      expect(secpMintOutput.getOutputID()).toBe(AXVMConstants.SECPMINTOUTPUTID)
